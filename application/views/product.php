		...
		<div class="container">
			<div class="row">
				...
				<div class="span4">
					...
					<p><i class="icon-phone"></i>&nbsp;Phone: 081330600031</p>
					<p><i class="icon-print"></i>&nbsp;Fax: 8889977</p>
					<p><i class="icon-envelope"></i>&nbsp;Email: grup9@gmail.com</p>
					<p><i class="icon-globe"></i>&nbsp;Web: http://www.grup9.com</p>
				</div>
